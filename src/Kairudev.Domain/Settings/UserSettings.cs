...
public sealed class UserSettings : AggregateRoot<int>
{
    ...
    private UserSettings(int id, ThemePreference themePreference) : base(id)
    {
    ...
    {
        return new UserSettings(SingletonId, ThemePreference.System);
    }
    ...
    /// </summary>
    public static UserSettings Reconstitute(int id, ThemePreference themePreference)
    {
        return new UserSettings(id, themePreference);
    }
}
